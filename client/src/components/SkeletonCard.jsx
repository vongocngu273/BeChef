...
export default function SkeletonCard() {
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-orange-100 p-6 flex flex-col justify-between animate-pulse space-y-5">
      {/* Header */}
      <div>
      ...
      {/* Texture & Yield */}
      <div className="p-3 bg-orange-50/50 rounded-xl space-y-2 border border-orange-100/50">
        <div className="h-4 bg-orange-100 rounded w-5/6"></div>
        <div className="h-3 bg-orange-100/70 rounded w-2/3"></div>
      </div>
